...
- `src/mltt/surface/` – surface syntax, parser, and desugaring (plus the surface prelude).
- `src/mltt/elab/` – surface elaboration into kernel terms (metadata, constraints, and type-directed elaboration).
